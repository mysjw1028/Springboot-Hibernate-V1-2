...
public class JwtAuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        String jwtToken = req.getHeader("Authorization");// 이 값부터 확인을 해봐야한다
        ...
        // 토큰검증 /board/1 ->put
        jwtToken = jwtToken.replace("Bearer ", "");// Bearer 뒤 공백 1칸 확인 !!
        ...
        // jwtToken = jwtToken.trim();// 앞뒤 공백을 날리는거 -> 안전하게 갈려고
